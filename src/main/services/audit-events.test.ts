...
describe('recordAuditEvent', () => {
  ...
  it('carries metadata through', () => {
    const event = recordAuditEvent({
      ...
      metadata: { before: { instructions: false, skills: [] }, after: { instructions: true, skills: [] } }
    })
...
describe('listAuditEvents', () => {
  it('orders newest first', () => {
    ...
    try {
      ...
      recordAuditEvent({ action: 'repo_cloned', repoPath: '~/code/second', summary: 'Cloned second' })
    } finally {
      vi.useRealTimers()
    }
