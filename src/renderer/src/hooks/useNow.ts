...
/**
 * A once-a-second clock for surfaces that time running turns. Nothing else
 * invalidates while a turn is simply continuing to run, so elapsed labels have
 * to re-render on their own —
